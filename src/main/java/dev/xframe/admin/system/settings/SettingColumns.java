...
public class SettingColumns {
    ...
    public static void reg(String key, EColumn type, String name, String hint) {
    ...
    public static void reg(String key, EColumn type, String name, String hint,  SettingListener listener) {
        reg(key, type, name, hint, "", listener);
    }
    public static void reg(String key, EColumn type, String name, String hint, String defaultValue) {
        reg(key, type, name, hint, defaultValue, SettingListener.Ignored);
    }
    public static void reg(String key, EColumn type, String name, String hint, String defaultValue, SettingListener listener) {
